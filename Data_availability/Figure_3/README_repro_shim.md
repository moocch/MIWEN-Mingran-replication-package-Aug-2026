...
- `energy_budget_nn_results.json` — GTSRB-CNN client-energy audit (panel g green overlay;
  byte-identical to `QPG-MIT/MIWEN_Mingran` @ `handoff/rung3-session` `analysis/`; audit code in
  `../../Code_availability/pipelines/energy_budget_nn/`, artifacts in `../raw/energy_budget_nn/`)
